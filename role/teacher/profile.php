            ...
            <div class="w3-container w3-margin-left">
                ...
                <form style="width:50%;" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
                    <fieldset style="padding:15px;">
                        ...
                        <input placeholder="Name" required="" name="teacher_name"class="w3-input w3-border w3-animate-input" type="text" value="<?php echo$_SESSION['teacher_name']; ?>"style="width:30%">
                    </fieldset>
