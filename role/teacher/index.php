        ...
        if (date('h:i:s a', time()) < '11:00:00 pm') {
            if (@mysqli_num_rows($result) == 0) {
                ...
                foreach ($name as $n) {
                    ...
                    $q2 = " WHERE `$subject_username`.`date` ='$date'";
                    for ($c = 0; $c < mysqli_num_rows($result); $c++) {
                        $rn = $roll_number[$c];
                        $at = $attendance[$c];
                        $q1.= " ,`$rn`='$at'";
...
<html>
    ...
    <body style="background:#e6e6e6;color:black;" id="body">
        ...
        <div id="main" style="margin-left:250px;transition:0.4s;">
            <div class="w3-container w3-margin-left">
                            ...
                            if (@mysqli_num_rows($result1) == 1) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            ?></td>
                                        <td>
                                            <input type="radio" required="" name="<?php echo $c; ?>"value="p"<?php if ($row1[$rno] == 'p') echo 'checked'; ?> />&nbsp;Present<br>
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="radio" required="" name="<?php echo $c; ?>"value="p" />&nbsp;Present<br>
                ...
                <?php echo "<h3>$err_msg</h3>";} else if ($template == 2) { ?> 
